...
(function(mod) {
  ...
  CodeMirror.defineMode("kotlin", function(config, parserConfig) {
    ...
    var keywords = words("package continue return object while break class data trait throw super" + " when type this else This try val var fun for is in if do as true false null get set");
